...
# kernel-lts, devel, headers, perf, tools and bpftool.
%ifarch x86_64
%define with_doc 0
...
# Packages that need to be present before kernel-lts is installed
...
# and obsoletes for the kernel-lts package.
...
# isn't required for the kernel-lts proper to function.\
AutoReq: no\
AutoProv: yes\
%{nil}
...
#
# This macro creates a kernel-lts-<subpackage>-devel package.
...
#
# This macro creates a kernel-lts-<subpackage>-modules-extra package.
...
#
# This macro creates a kernel-lts-<subpackage>-modules package.
...
#
# This macro creates a kernel-lts-<subpackage> meta package.
...
#
# This macro creates a kernel-lts-<subpackage>
...
# We'll get it from the linux-firmware package and we don't want conflicts. # @TODO: INSTALL_MOD_STRIP=1
...
#
# Generate the kernel-lts-core and kernel-lts-modules file lists.
#
...
# We use this for the directory lists in kernel-lts-core.
...
# Purge the kernel-lts-devel tree of leftover junk.
...
# Compute a content hash to export as Provides: kernel-lts-headers-checksum.
...
#
# This macro defines a %%post script for a kernel-lts package and its devel package.
...
#
# This macro defines a %%preun script for a kernel-lts package.
...
#
# This macro defines the %%files sections for the kernel-lts package
# and its corresponding devel package.
